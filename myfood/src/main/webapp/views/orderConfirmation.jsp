		...
		<div id="container" style="width: 100%; height: 100%;float:left;">
			<div id="container-top" style="width: 100%; height: 100%;float:left;">
				...
				<div id="container-top-left-top"
						style="width: 50%; height: 100%; overflow-y: scroll; float: left;">
						<table>
						<tr><td width="400" align="left" valign="top" style="padding-left: 60px; padding-right: 10px;font-family:Arial;"><label>Estimated Delivery Time </label></td><td align="center"><input type="text" id="hh"><label>(hh)</label></td><td width="20" align="left" valign="top" style="padding-left: 5px; padding-right: 5px;font-family:Arial;"><label>:</label></td><td align="center"><input type="text" id="mm"><label >(mm)</label></td></tr>
						<tr><td width="400" align="left" valign="top" style="padding-left: 60px; padding-right: 10px;font-family:Arial;"><label>Reason for cancellation</label></td><td><input type="text" id="comments" name="comments"></td></tr>
						</table>
						<table>
						<tr><td style="padding-left: 60px; padding-right: 10px;"><input type="submit" name="Confirm" class="btn-lg btn-primary" id="Confirm" value="Confirm" onclick="location.href='${userActionUrlConfirm}/${orderId}/'+document.getElementById('hh').value+'/'+document.getElementById('mm').value+validateDeliveryTime();"></td>
						<td><input type="submit" name="Cancel" class="btn-lg btn-primary" id="Cancel" value="Cancel" onclick="location.href='${userActionUrl}/${orderId}/'+document.getElementById('comments').value+validateComments();">
						</td></tr>
						</table>
				</div>
			</div>
